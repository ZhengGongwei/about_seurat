...
my36colors <-c("#E5D2DD", "#53A85F", "#F1BB72", "#F3B1A0", "#D6E7A3", "#57C3F3", "#476D87", "#E95C59", "#E59CC4", "#AB3282", "#23452F", "#BD956A", "#8C549C", "#585658", "#9FA3A8", "#E0D4CA", "#5F3D69", "#C5DEBA", "#58A4C3")
markers <- c("CD3D", "S100A8", "S100A9", "CD79A", "CCL5", "NKG7", "GZMA", "IL32", "CD4", "CD8A", "LTB", "FCN1", "MS4A1", "SPON2","FCER1A","SERPINF1", "TMEM40", "CD3E")
VlnPlot(pbmc3k, features = markers,stack=T,pt.size=0.9,cols = my36colors)+theme(axis.text.x = element_blank(),axis.ticks.x = element_blank())#不显示坐标刻度 
